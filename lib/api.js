...
export const getMyRoleInGroup = async (groupId) => {
    const response = await axiosInstance.get(`/group/${groupId}/role`);
    return response.data;
}
...
export const getMyRoleInProject = async (groupId, projectId) => {
    const response = await axiosInstance.get(`/group/${groupId}/project/${projectId}/role`);
    return response.data;
}
